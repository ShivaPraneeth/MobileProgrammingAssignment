...
public class RegisterFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_register = view.findViewById(R.id.signup);
            ...
            if (!checkEmptyfields()) {
                if(edt_gender.getText().toString().length()>1)
                {
                    ...
                    if (edt_date.getText().toString().length() < 10) {
                        edt_date.setError("Invalid phone Number");
                        ...
                        if (edt_pass.getText().length() < 6) {
                            ...
                            if (!edt_pass.getText().toString().equals(edt_cpass.getText().toString())) {
                                ...
                                Person person = new Person(email, firstname, lastname, pass, date, city, gender, mobilenumber);
